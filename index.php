...
<body onload="setSystem()">
    ...
    <div class="container">
        ...
        <div class="form-control">
            <form action="javascript:insertComment()">
                <div class="form">
                    <div class="form-left">
                        <div class="studentName inputBlog">
                            ...
                            <br>
                            <input required type="text" name="stdId" id="stdId" class="stdId inputText" placeholder="640000000-1">
                        </div>
                        <div class="firstName inputBlog">
                            <label for="fname">ชื่อ-สกุล : </label>
                            <br>
                            <input required type="text" name="fname" id="name" class="fname inputText" placeholder="สมชาย รักเรียน">
                        </div>
                        <div class="major-grade">
                            <div class="major">
                                <label for="majorName">หลักสูตร : </label>
                                <br>
                                <select required name="inputmajor" id="inputmajor" onchange="getTeacher()" class="major inputText">
                            ...
                            <div class="grade">
                                ...
                                <br>
                                <select required name="grade" id="grade" class="grade inputText">
                    ...
                    <div class="form-right">
                        ...
                        <br>
                        <select required name="teacher" id="teacher" class="tea inputText">
                        </select>
                        <div class="comment">
                            <label for="commentName">คำอวยพร :</label>
                            <br>
                            <textarea required name="comment" id="comment" class="commentInput teacher"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <button class="btn btn-save" type="submit">ส่งคำอวยพร</button>
            </form>
        </div>
        <hr>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#233E8B" fill-opacity="1" d="M0,160L80,160C160,160,320,160,480,176C640,192,800,224,960,229.3C1120,235,1280,213,1360,202.7L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
